...
1. **[affaan-m/everything-claude-code](https://github.com/affaan-m/everything-claude-code)** - ⭐ 32,880
   - Complete Claude Code configuration collection - agents, skills, hooks, commands, rules, MCPs. Battle-tested configs from an Anthropic hackathon winner.

2. **[hesreallyhim/awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)** - ⭐ 22,083
   - A curated list of awesome skills, hooks, slash-commands, agent orchestrators, applications, and plugins for Claude Code by Anthropic

3. **[OthmanAdi/planning-with-files](https://github.com/OthmanAdi/planning-with-files)** - ⭐ 11,616
   - Claude Code skill implementing Manus-style persistent markdown planning — the workflow pattern behind the $2B acquisition.

### All Projects

4. [diet103/claude-code-infrastructure-showcase](https://github.com/diet103/claude-code-infrastructure-showcase) - ⭐ 8,654
   - Examples of my Claude Code infrastructure with skill auto-activation, hooks, and agents

5. [travisvn/awesome-claude-skills](https://github.com/travisvn/awesome-claude-skills) - ⭐ 6,094
   - A curated list of awesome Claude Skills, resources, and tools for customizing Claude AI workflows — particularly Claude Code

6. [ChrisWiles/claude-code-showcase](https://github.com/ChrisWiles/claude-code-showcase) - ⭐ 5,124
   - Comprehensive Claude Code project configuration example with hooks, skills, agents, commands, and GitHub Actions workflows

7. [coreyhaines31/marketingskills](https://github.com/coreyhaines31/marketingskills) - ⭐ 5,021
   - Marketing skills for Claude Code and AI agents. CRO, copywriting, SEO, analytics, and growth engineering.

8. [sickn33/antigravity-awesome-skills](https://github.com/sickn33/antigravity-awesome-skills) - ⭐ 4,554
...
9. [blader/humanizer](https://github.com/blader/humanizer) - ⭐ 3,367
   - Claude Code skill that removes signs of AI-generated writing from text

10. [zebbern/claude-code-guide](https://github.com/zebbern/claude-code-guide) - ⭐ 3,225
...
11. [Yeachan-Heo/oh-my-claudecode](https://github.com/Yeachan-Heo/oh-my-claudecode) - ⭐ 3,152
...
12. [PleasePrompto/notebooklm-skill](https://github.com/PleasePrompto/notebooklm-skill) - ⭐ 2,796
...
13. [glitternetwork/pinme](https://github.com/glitternetwork/pinme) - ⭐ 2,643
...
15. [czlonkowski/n8n-skills](https://github.com/czlonkowski/n8n-skills) - ⭐ 2,236
   - n8n skillset for Claude Code to build flawless n8n workflows

16. [trailofbits/skills](https://github.com/trailofbits/skills) - ⭐ 2,097
   - Trail of Bits Claude Code skills for security research, vulnerability detection, and audit workflows

17. [op7418/Humanizer-zh](https://github.com/op7418/Humanizer-zh) - ⭐ 1,755
   - Humanizer 的汉化版本，Claude Code Skills，旨在消除文本中 AI 生成的痕迹。

18. [zechenzhangAGI/AI-research-SKILLs](https://github.com/zechenzhangAGI/AI-research-SKILLs) - ⭐ 1,660
   - Comprehensive open-source library of AI research and engineering skills for any AI model. Package the skills and your claude code/codex/gemini agent will be an AI research agent with full horsepower. Maintained by Orchestra Research.

19. [lackeyjb/playwright-skill](https://github.com/lackeyjb/playwright-skill) - ⭐ 1,495
   - Claude Code Skill for browser automation with Playwright. Model-invoked - Claude autonomously writes and executes custom automation for testing and validation.

20. [blader/Claudeception](https://github.com/blader/Claudeception) - ⭐ 1,475
   - A Claude Code skill for autonomous skill extraction and continuous learning. Have Claude Code get smarter as it works.

21. [alirezarezvani/claude-skills](https://github.com/alirezarezvani/claude-skills) - ⭐ 1,426
...
22. [mvanhorn/last30days-skill](https://github.com/mvanhorn/last30days-skill) - ⭐ 1,237
   - Claude Code skill that researches any topic across Reddit + X from the last 30 days, then writes copy-paste-ready prompts

23. [CloudAI-X/claude-workflow-v2](https://github.com/CloudAI-X/claude-workflow-v2) - ⭐ 1,214
   - Universal Claude Code workflow plugin with agents, skills, hooks, and commands

24. [jeremylongshore/claude-code-plugins-plus-skills](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) - ⭐ 1,094
   - Hundreds of Claude Code plugins with embedded AI skills. Learn via interactive Jupyter tutorials.

25. [axtonliu/axton-obsidian-visual-skills](https://github.com/axtonliu/axton-obsidian-visual-skills) - ⭐ 1,039
   - Visual Skills Pack for Obsidian: generate Canvas, Excalidraw, and Mermaid diagrams from text with Claude Code

26. [gadievron/raptor](https://github.com/gadievron/raptor) - ⭐ 1,028
...
27. [jarrodwatts/claude-code-config](https://github.com/jarrodwatts/claude-code-config) - ⭐ 884
   - My personal Claude Code configuration - rules, hooks, agents, skills, and commands

28. [numman-ali/n-skills](https://github.com/numman-ali/n-skills) - ⭐ 866
   - Curated plugin marketplace for AI agents - works with Claude Code, Codex, and openskills

29. [Prat011/awesome-llm-skills](https://github.com/Prat011/awesome-llm-skills) - ⭐ 767
...
30. [Ceeon/videocut-skills](https://github.com/Ceeon/videocut-skills) - ⭐ 606
...
1. **[ComposioHQ/awesome-claude-skills](https://github.com/ComposioHQ/awesome-claude-skills)** - ⭐ 27,053
   - A curated list of awesome Claude Skills, resources, and tools for customizing Claude AI workflows

2. **[vercel-labs/agent-skills](https://github.com/vercel-labs/agent-skills)** - ⭐ 17,249
   - Vercel's official collection of agent skills

3. **[muratcankoylan/Agent-Skills-for-Context-Engineering](https://github.com/muratcankoylan/Agent-Skills-for-Context-Engineering)** - ⭐ 7,879
   - A comprehensive collection of Agent Skills for context engineering, multi-agent architectures, and production agent systems. Use when building, optimizing, or debugging agent systems that require effective context management.

### All Projects

4. [VoltAgent/awesome-claude-skills](https://github.com/VoltAgent/awesome-claude-skills) - ⭐ 4,382
...
10. [expo/skills](https://github.com/expo/skills) - ⭐ 739
   - A collection of AI agent skills for working with Expo projects and Expo Application Services

11. [callstackincubator/agent-skills](https://github.com/callstackincubator/agent-skills) - ⭐ 735
   - A collection of agent-optimized React Native skills for AI coding assistants.

12. [BrownFineSecurity/iothackbot](https://github.com/BrownFineSecurity/iothackbot) - ⭐ 521
   - IoT HackBot: A collection of Claude Skills and custom tooling for hybrid IoT pentesting

13. [abubakarsiddik31/claude-skills-collection](https://github.com/abubakarsiddik31/claude-skills-collection) - ⭐ 406
...
14. [snarktank/amp-skills](https://github.com/snarktank/amp-skills) - ⭐ 390
   - Collection of Amp AI coding agent skills for marketing, content, and development workflows

15. [Code-and-Sorts/awesome-copilot-agents](https://github.com/Code-and-Sorts/awesome-copilot-agents) - ⭐ 350
...
16. [softaworks/agent-toolkit](https://github.com/softaworks/agent-toolkit) - ⭐ 319
...
17. [guo-yu/skills](https://github.com/guo-yu/skills) - ⭐ 217
   - My collection of skills for productivity and automation.

18. [rmyndharis/antigravity-skills](https://github.com/rmyndharis/antigravity-skills) - ⭐ 169
   - A curated collection of Agent Skills for Google Antigravity

19. [JayZeeDesign/awesome-claude-skills](https://github.com/JayZeeDesign/awesome-claude-skills) - ⭐ 160

20. [HoangNguyen0403/agent-skills-standard](https://github.com/HoangNguyen0403/agent-skills-standard) - ⭐ 143
   - A collection of Agent Skills Standard and Best Practice for Programming Languages, Frameworks that help our AI Agent follow best practies on frameworks and programming laguages

21. [Agent-3-7/agent37-skills-collection](https://github.com/Agent-3-7/agent37-skills-collection) - ⭐ 130
   - Collection of useful Claude AI skills and commands

22. [aaron-he-zhu/seo-geo-claude-skills](https://github.com/aaron-he-zhu/seo-geo-claude-skills) - ⭐ 128
...
23. [fleurytian/awesome-claude-skills](https://github.com/fleurytian/awesome-claude-skills) - ⭐ 115
...
24. [Microck/ordinary-claude-skills](https://github.com/Microck/ordinary-claude-skills) - ⭐ 112
   - An unappealing collection of Claude Skills and resources.

25. [tilework-tech/nori-skillsets](https://github.com/tilework-tech/nori-skillsets) - ⭐ 106
   - System for managing collections of agent skills. Switch between skillsets seamlessly!

26. [new-silvermoon/awesome-android-agent-skills](https://github.com/new-silvermoon/awesome-android-agent-skills) - ⭐ 106
...
3. **[kepano/obsidian-skills](https://github.com/kepano/obsidian-skills)** - ⭐ 8,415
   - Agent skills for Obsidian

4. **[agentskills/agentskills](https://github.com/agentskills/agentskills)** - ⭐ 7,599
...
6. **[eastlondoner/vibe-tools](https://github.com/eastlondoner/vibe-tools)** - ⭐ 4,684
   - Give Cursor Agent an AI Team and Advanced Skills

### All Projects

7. [vercel-labs/skills](https://github.com/vercel-labs/skills) - ⭐ 2,864
   - The open agent skills tool - npx skills

8. [remotion-dev/skills](https://github.com/remotion-dev/skills) - ⭐ 1,020
   - Agent Skills

9. [wrtnlabs/agentica](https://github.com/wrtnlabs/agentica) - ⭐ 989
   - TypeScript AI AI Function Calling Framework enhanced by compiler skills.

10. [itsmostafa/aws-agent-skills](https://github.com/itsmostafa/aws-agent-skills) - ⭐ 978
   - AWS Skills for Agents

11. [supabase/agent-skills](https://github.com/supabase/agent-skills) - ⭐ 816
   - Agent Skills to help developers using AI agents with Supabase

12. [antonbabenko/terraform-skill](https://github.com/antonbabenko/terraform-skill) - ⭐ 787
...
14. [hyf0/vue-skills](https://github.com/hyf0/vue-skills) - ⭐ 753
   - Agent skills for Vue 3 development

15. [skillcreatorai/Ai-Agent-Skills](https://github.com/skillcreatorai/Ai-Agent-Skills) - ⭐ 629
...
17. [adithya-s-k/manim_skill](https://github.com/adithya-s-k/manim_skill) - ⭐ 497
   - Agent skills for Manim to create 3Blue1Brown style animations.

18. [ast-grep/agent-skill](https://github.com/ast-grep/agent-skill) - ⭐ 461

19. [Kamalnrf/claude-plugins](https://github.com/Kamalnrf/claude-plugins) - ⭐ 392
...
20. [opensolon/solon-ai](https://github.com/opensolon/solon-ai) - ⭐ 288
...
21. [notedit/happy-skills](https://github.com/notedit/happy-skills) - ⭐ 285
   - happy coding  agent

22. [benchflow-ai/skillsbench](https://github.com/benchflow-ai/skillsbench) - ⭐ 273
   - SkillsBench evaluates how well skills work and how effective agents are at using them

23. [zippoxer/subtask](https://github.com/zippoxer/subtask) - ⭐ 270
   - Claude Skill to do your tasks with subagents in Git worktrees

24. [disler/agent-sandbox-skill](https://github.com/disler/agent-sandbox-skill) - ⭐ 259
   - An agent skill for managing isolated execution environments

25. [YuJunZhiXue/github-skill-forge](https://github.com/YuJunZhiXue/github-skill-forge) - ⭐ 240
   - 一个"制造技能的技能"。这个工具自动化了将任意 GitHub 仓库转换为标准化技能的全过程，是扩展 AI Agent 能力的核心工具。

26. [ramziddin/solid-skills](https://github.com/ramziddin/solid-skills) - ⭐ 234
   - AI agent skill for writing senior-engineer quality code through SOLID principles, TDD, and clean architecture

27. [vueuse/skills](https://github.com/vueuse/skills) - ⭐ 231
   - Agent Skills for VueUse

28. [vstorm-co/pydantic-deepagents](https://github.com/vstorm-co/pydantic-deepagents) - ⭐ 229
...
29. [qufei1993/skills-hub](https://github.com/qufei1993/skills-hub) - ⭐ 189
...
30. [getsentry/skills](https://github.com/getsentry/skills) - ⭐ 159
...
7. [joeseesun/anything-to-notebooklm](https://github.com/joeseesun/anything-to-notebooklm) - ⭐ 269
   - Claude Skill: Multi-source content processor for NotebookLM. Supports WeChat articles, web pages, YouTube, PDF, Markdown, search queries → Podcast/PPT/MindMap/Quiz etc.

8. [scraperai/scraperai](https://github.com/scraperai/scraperai) - ⭐ 243
   - ScraperAI is an open-source, AI-powered tool designed to simplify web scraping for users of all skill levels.

9. [iamzhihuix/happy-claude-skills](https://github.com/iamzhihuix/happy-claude-skills) - ⭐ 241

10. [waynesutton/convexskills](https://github.com/waynesutton/convexskills) - ⭐ 232
...
11. [coffeefuelbump/csv-data-summarizer-claude-skill](https://github.com/coffeefuelbump/csv-data-summarizer-claude-skill) - ⭐ 196
...
12. [haunchen/n8n-skills](https://github.com/haunchen/n8n-skills) - ⭐ 164
   - Designed specifically for AI assistants, the n8n Workflow Automation Skills Suite.

13. [zarazhangrui/youtube-to-ebook](https://github.com/zarazhangrui/youtube-to-ebook) - ⭐ 160
...
14. [microsoft/AzureSuperpowers](https://github.com/microsoft/AzureSuperpowers) - ⭐ 136
...
2. **[timescale/pg-aiguide](https://github.com/timescale/pg-aiguide)** - ⭐ 1,454
   - MCP server and Claude plugin for Postgres skills and documentation. Helps AI coding tools generate better PostgreSQL code.

3. **[browserwing/browserwing](https://github.com/browserwing/browserwing)** - ⭐ 621
...
4. [intellectronica/skillz](https://github.com/intellectronica/skillz) - ⭐ 338
   - An MCP server for loading skills (shim for non-claude clients).

5. [better-auth/better-icons](https://github.com/better-auth/better-icons) - ⭐ 338
   - Skill and MCP server for searching and retrieving icons

6. [K-Dense-AI/claude-skills-mcp](https://github.com/K-Dense-AI/claude-skills-mcp) - ⭐ 290
   - MCP server for searching and retrieving Claude Agent Skills using vector search

7. [gotalab/skillport](https://github.com/gotalab/skillport) - ⭐ 273
...
9. [Hmbown/aleph](https://github.com/Hmbown/aleph) - ⭐ 120
   - Skill + MCP server for recursive LLM reasoning. Load context, iterate with search/code/think tools, converge on answers.

10. [GBSOSS/-mcp-to-skill-converter](https://github.com/GBSOSS/-mcp-to-skill-converter) - ⭐ 112
...
1. **[op7418/NanoBanana-PPT-Skills](https://github.com/op7418/NanoBanana-PPT-Skills)** - ⭐ 1,024
   - NanoBanana PPT Skills 基于 AI 自动生成高质量 PPT 图片和视频的强大工具，支持智能转场和交互式播放

2. **[simonw/claude-skills](https://github.com/simonw/claude-skills)** - ⭐ 910
...
3. **[techiescamp/golang-for-devops](https://github.com/techiescamp/golang-for-devops)** - ⭐ 156
...
2. **[luwill/research-skills](https://github.com/luwill/research-skills)** - ⭐ 122
...
1. [brucevanfdm/agent-skills-guard](https://github.com/brucevanfdm/agent-skills-guard) - ⭐ 211
...
3. **[openai/skills](https://github.com/openai/skills)** - ⭐ 2,115
   - Skills Catalog for Codex

4. **[mrgoonie/claudekit-skills](https://github.com/mrgoonie/claudekit-skills)** - ⭐ 1,483
...
6. [huangserva/skill-prompt-generator](https://github.com/huangserva/skill-prompt-generator) - ⭐ 946
   - 这是一个基于Claude Skill的**AI人像Prompt生成系统**，能够从特征库中智能组合生成高质量的人像描述Prompt，并具备自动学习和库扩展能力。 核心能力: Prompt生成、特征提取、自动学习、智能审核、版本控制

7. [google-labs-code/stitch-skills](https://github.com/google-labs-code/stitch-skills) - ⭐ 907

8. [SynaLinks/synalinks-skills](https://github.com/SynaLinks/synalinks-skills) - ⭐ 894
   - Claude skills for Synalinks

9. [NVIDIA-NeMo/Skills](https://github.com/NVIDIA-NeMo/Skills) - ⭐ 797
   - A project to improve skills of large language models

10. [op7418/Youtube-clipper-skill](https://github.com/op7418/Youtube-clipper-skill) - ⭐ 783

11. [microsoft/cookiecutter-spacy-fastapi](https://github.com/microsoft/cookiecutter-spacy-fastapi) - ⭐ 623
   - Cookiecutter API for creating Custom Skills for Azure Search using Python and Docker

12. [instavm/open-skills](https://github.com/instavm/open-skills) - ⭐ 340
   - OpenSkills: Run Claude Skills Locally using any LLM

13. [ailabs-393/ai-labs-claude-skills](https://github.com/ailabs-393/ai-labs-claude-skills) - ⭐ 286
...
14. [dgreenheck/webgpu-claude-skill](https://github.com/dgreenheck/webgpu-claude-skill) - ⭐ 270
   - A Claude skill for developing WebGPU applications with Three.js

15. [ginobefun/deep-reading-analyst-skill](https://github.com/ginobefun/deep-reading-analyst-skill) - ⭐ 255
   - A professional Claude AI skill for deep reading analysis

16. [vercel-labs/next-skills](https://github.com/vercel-labs/next-skills) - ⭐ 240

17. [granaje/alexa-ia-openai](https://github.com/granaje/alexa-ia-openai) - ⭐ 223
   - La skill de Alexa con API de OpenAi

18. [Ryota-Kawamura/LangChain-for-LLM-Application-Development](https://github.com/Ryota-Kawamura/LangChain-for-LLM-Application-Development) - ⭐ 206
...
19. [chujianyun/skills](https://github.com/chujianyun/skills) - ⭐ 203
   - WuMing's Claude Skills

20. [microsoft/AISkillsForWindows](https://github.com/microsoft/AISkillsForWindows) - ⭐ 170
   - Contains samples for implementing Windows Skills by extending the preview base API and using exsting skill packages

21. [paulotruta/alexa-skill-llm-intent](https://github.com/paulotruta/alexa-skill-llm-intent) - ⭐ 152
   - Alexa Skill that provides turn based conversations with an AI LLM. Bringing AI to your Alexa, because Amazon doesn't.

22. [spences10/svelte-claude-skills](https://github.com/spences10/svelte-claude-skills) - ⭐ 150

23. [cncf/llm-in-action](https://github.com/cncf/llm-in-action) - ⭐ 146
   - 🤖 Discover how to apply your LLM app skills on Kubernetes!

24. [drewocarr/generate-shortcuts-skill](https://github.com/drewocarr/generate-shortcuts-skill) - ⭐ 139
   - a little skill that explains the shortcuts plist format to claude

25. [microsoft/moaw](https://github.com/microsoft/moaw) - ⭐ 136
...
26. [NTCoding/claude-skillz](https://github.com/NTCoding/claude-skillz) - ⭐ 135
   - Random Claude skills for common, simple programming tasks

27. [timedomain-tech/open-creator](https://github.com/timedomain-tech/open-creator) - ⭐ 128
...
28. [distil-labs/distil-cli-skill](https://github.com/distil-labs/distil-cli-skill) - ⭐ 122
   - Claude skill for distil cli

29. [staruhub/ClaudeSkills](https://github.com/staruhub/ClaudeSkills) - ⭐ 113
   - Some sharing on Claude Skills

30. [feiskyer/codex-settings](https://github.com/feiskyer/codex-settings) - ⭐ 110
